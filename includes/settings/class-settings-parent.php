...
class Settings_Parent
{
    ...
    public function add_section()
    {
        add_settings_section(
            $this->id,
            __( $this->title, 'simple_gdpr_cookies' ),
    ...
    {
        if ( $this->option === 'simple_gdpr_cookies_cookie_settings' ) {
            $html = '<div class="notice notice-info">
	                    <p>
	                    ' . __('A cookie will be set to control the display of the banner.
                        Depending on the plugin settings and the user\'s choice, the cookie <strong>sgc_user_consent</strong> will be set to one of the following values:', 'simple_gdpr_cookies') . '		
	                    </p>
	                    <p>
	                    ' . __('If the <strong>User Consent Settings</strong> is set to <strong>Choice</strong>, within the <strong>Content Settings</strong> tab,', 'simple_gdpr_cookies') . '                
	                    <ol>
	                        <li>' . __('If user accepts, value will be <em>true</em>.', 'simple_gdpr_cookies') . '</li>
	                        <li>' . __('If user declines, value will be <em>false</em>.', 'simple_gdpr_cookies') . '</li>
                        </ol>
                        ' . __('If the <strong>User Consent Settings</strong> is set to <strong>Default</strong>, the cookie value will be <em>default</em>.', 'simple_gdpr_cookies') . '
                        </p>
	                    <p>' . __('The cookie will last as long as the specified duration below. While the cookie is set, users will not see the banner.', 'simple_gdpr_cookies') . '</p>
            </div>';
